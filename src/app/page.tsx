...
function Hero() {
  ...
  const featured = [
    { brand: "Ferrari", name: "Roma",     type: "Sports Car",   price: 12000, emoji: "🏎️", tag: "Hot" },
    { brand: "BMW",     name: "5 Series", type: "Sedan",        price: 8000,  emoji: "🚗", tag: "Luxury" },
    { brand: "RE",      name: "Bullet",   type: "Cruiser",      price: 1500,  emoji: "🏍️", tag: null },
  ];
